...
public class UserDAO {
	...
	public static void main(String[] args) {
		...
		System.out.println(UserDAO.isValidate(test));
		System.out.println(UserDAO.inserUser(new User("Thien", "teo")));
//		for (int i = 0; i < listUser.size(); i++) {
//			System.out.println(listUser.get(i).getUser()+"   " +listUser.get(i).getPassword());
//			
//		}
		UserDAO.inserUser(new User("Tam", "123"));
		System.out.println(UserDAO.isValidate(new User("Tam", "123s")));
	}
